...
export type ArrayInterpolation<MergedProps, StyleType extends ReactNativeStyle = ReactNativeStyle> = Array<
  Interpolation<MergedProps, StyleType>
>;
