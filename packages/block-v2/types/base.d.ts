 ...
 * @typeparam SpecificComponentProps  Props which will *not* be included when withComponent is called
 */
export interface CreateBlockComponent<
  ComponentProps extends {},
  SpecificComponentProps extends {} = {},
  JSXProps extends {} = {},
 ...
 *
 * @example block(MyComponent)({ width: 100 })
 * @example block(MyComponent)(myComponentProps => ({ width: myComponentProps.width })
 * @example block(View)({ width: 100 })
 * @example block(View)<Props>(props => ({ width: props.width })
 */
